...
db.serialize(function(err, rows) {
  ...
  db.run("INSERT INTO teachers (first_name, last_name, email, gender) VALUES ('Davina', 'Bonadilla', 'davina.bonadilla@gmail.com', 'Wanita');");
  if(err){
    console.log('Error insert into database teachers')
  }
  console.log('Success insert into database teachers');
});
